...
<head>
	...
	<!-- Site favicon -->
	<link rel="apple-touch-icon" sizes="180x180" href="/assignment_java_5/views/vendors/images/apple-touch-icon.png">
	<link rel="icon" type="image/png" sizes="32x32" href="/assignment_java_5/views/vendors/images/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="/assignment_java_5/views/vendors/images/favicon-16x16.png">
	...
	<link rel="stylesheet" type="text/css" href="/assignment_java_5/views/vendors/styles/icon-font.min.css">
		...
		<div class="pd-10">
			<div class="error-page-wrap text-center">
				...
				<div class="pt-20 mx-auto max-width-200">
					<a href="/assignment_java_5/shop/products" class="btn btn-primary btn-block btn-lg">Back To Home</a>
				</div>
			</div>
		</div>
	</div>
