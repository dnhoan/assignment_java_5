			...
			<div class="dropdown">
				<a class="dropdown-toggle" href="#" role="button"
					data-toggle="dropdown"> <span class="user-icon"> <img
						src="/assignment_java_5/views/vendors/images/photo1.jpg" alt="" />
				</span> <c:if test="${!empty sessionScope.user }">
				...
				<div
					...
					<a class="dropdown-item" href="profile.html"><i
						...
						href="profile.html"><i class="dw dw-settings2"></i> Setting</a>
					<c:if test="${!empty sessionScope.user }">
						<a class="dropdown-item" href="faq.html"><i class="dw dw-help"></i>
							Đổi mật khẩu</a>
						<a class="dropdown-item" href="/assignment_java_5/logout"><i
							class="dw dw-logout"></i>Đăng xuất</a>
					</c:if>
					<c:if test="${empty sessionScope.user }">
						<a class="dropdown-item" href="/assignment_java_5/login"><i
							class="dw dw-logout"></i>Đăng nhập</a>
						<a class="dropdown-item" href="/assignment_java_5/login"><i
							class="dw dw-logout"></i>Đăng ký</a>
					</c:if>
				</div>
			</div>
		</div>
			...
			<div class="sidebar-radio-group pb-10 mb-10">
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" id="sidebaricon-1" name="menu-dropdown-icon"
						class="custom-control-input" value="icon-style-1" checked="" /> <label
						class="custom-control-label" for="sidebaricon-1"><i
...
<div class="left-side-bar">
	<div class="brand-logo">
		<a href="index.html"> <img
			src="/assignment_java_5/views/vendors/images/deskapp-logo.svg" alt=""
			class="dark-logo" /> <img
			src="/assignment_java_5/views/vendors/images/deskapp-logo-white.svg"
			...
			<ul id="accordion-menu">
				...
				<li class="dropdown"><a href="javascript:;"
					class="dropdown-toggle"> <span class="micon dw dw-edit2"></span><span
						class="mtext">Quản lý</span>
				</a>
					<ul class="submenu">
						<li><a href="/assignment_java_5/admin/users/index">Người
								dùng</a></li>
						<li><a href="/assignment_java_5/admin/categories/index">Danh
								mục</a></li>
						<li><a href="/assignment_java_5/admin/products/index">Sản
								phẩm</a></li>
