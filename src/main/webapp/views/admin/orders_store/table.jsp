...
<a class="btn btn-primary"
	href="/assignment_java_5/admin/ordersStore/create">Tạo đơn hàng</a>
			...
			<tr>
					...
					<div class="dropdown">
						...
						<div
							...
							<a class="btn dropdown-item" data-bs-toggle="modal"
								...
								href="/assignment_java_5/admin/ordersStore/edit/${order.id }"><i
								...
								<div class="modal-body">
									...
									<div class="row">
										<div class="col-6">
											...
											<p>
												<b>Họ tên: </b>${order.nameCustomer }</p>
											<p>
				...
				<td style="width: 200px;"><c:if
						...
						<button type="button" class="btn btn-danger" data-toggle="tooltip"
							data-placement="top" title="Hủy đơn hàng" data-bs-toggle="modal"
						...
						<div class="modal fade" id="cancel${order.id }" tabindex="-1"
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form method="post"
											action="/assignment_java_5/admin/ordersStore/updateStatus/${order.id }?status=2">
											<div class="mb-3">
						...
						<button type="button" class="btn btn-primary"
							...
							title="Xác nhận đơn hàng" data-bs-toggle="modal"
							data-bs-target="#confirm${order.id }">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<a class="btn btn-primary"
											href="/assignment_java_5/admin/ordersStore/updateStatus/${order.id }?status=1">Xác
											nhận</a>
									</div>
								</div>
							</div>
						...
						<button type="button" class="btn btn-warning"
							data-toggle="tooltip" data-placement="top" title="Đang giao"
								...
								<div class="modal-content">
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-secondary"
											data-bs-dismiss="modal">Không</button>
										<a class="btn btn-primary"
											href="/assignment_java_5/admin/ordersStore/updateStatus/${order.id }?status=3">Xác
											nhận</a>
									</div>
								</div>
							</div>
						...
						<button type="button" class="btn btn-success"
							data-toggle="tooltip" data-placement="top"
							title="Giao hàng thành công" data-bs-toggle="modal"
							data-bs-target="#success${order.id }">
								...
								<div class="modal-content">
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-secondary"
											data-bs-dismiss="modal">Không</button>
										<a class="btn btn-primary"
											href="/assignment_java_5/admin/ordersStore/updateStatus/${order.id }?status=4">Xác
											nhận</a>
									</div>
								</div>
							</div>
	...
	<ul class="pagination">
		<c:if test="${!items.first}">
			<li class="page-item"><a class="page-link"
				href="/assignment_java_5/admin/ordersStore/index?page=${ items.number - 1}"
		...
		<c:forEach var="index" begin="0" end="${items.totalPages - 1 }">
			<li class="page-item ${items.number == index ? "
				...
				href="/assignment_java_5/admin/ordersStore/index?page=${ index }">${index + 1 }</a>
			</li>
		</c:forEach>
