...
<div class="row">
	<div class="col-lg-8">
		...
		<table class="table">
			...
			<tbody>
				<c:forEach var="orderDetail" items="${ordersStore.orderDetailStores }">
					<tr>
						<td><img alt="" width="50"
											...
											<div class="padding-bottom-30 row"
												...
												<div class="col-6">
													<a class="btn btn-primary"
														href="/assignment_java_5/admin/ordersStore/create/removeProduct/${orderDetail.product.id }"><i
		...
		<h3 class="card-text text-danger fs-3 fw-bolder float-end">
			Tổng tiền:
			<fmt:setLocale value="vi-VN" />
			<fmt:formatNumber value="${ordersStore.totalMoney}" type="currency"
				minFractionDigits="0" />
		</h3>
	</div>
	<div class="col-lg-4">
		<h3 class="mb-3">Thông tin đơn hàng</h3>
		<form:form method="post" action="/assignment_java_5/admin/ordersStore/store"
			modelAttribute="orderStoreInfo">
			<div class="row">
				<div class="">
					<div class="mt-3">
						<label class="form-label" for="nameCustomer">Họ tên khách hàng</label>
