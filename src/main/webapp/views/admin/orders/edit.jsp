...
<div class="row">
	<div class="col-lg-8">
		...
		<table class="table">
			...
			<tbody>
				<c:forEach var="orderDetail" items="${orderEdit.orderDetails }">
					<tr>
						<td><img alt="" width="50"
											...
											<div class="padding-bottom-30 row"
												...
												<div class="col-6">
													<a class="btn btn-primary"
														href="/assignment_java_5/admin/orders/delete/${orderEdit.id }/${orderDetail.id }"><i
	...
	<div class="col-lg-4">
		...
		<p><b>Họ tên khách hàng: </b>${orderEdit.user.fullname }</p>
		<p><b>Email khách hàng: </b>${orderEdit.user.email }</p>
		<p><b>Số điện thoại: </b>${orderEdit.user.phoneNumber}</p>
		<p><b>Địa chỉ khách hàng: </b>${orderEdit.user.address}</p>
		<form:form method="post" action="/assignment_java_5/admin/orders/updateInfo/${orderEdit.id }"
