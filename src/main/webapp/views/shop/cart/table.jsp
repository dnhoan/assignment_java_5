		...
		<c:forEach var="orderDetail" items="${order.orderDetails }">
			<tr>
				...
				<td>
					...
					<div class="modal fade" id="delete${orderDetail.product.id }" tabindex="-1"
						role="dialog" aria-hidden="true">
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-body text-center font-18">
									<h4 class="padding-top-30 mb-30 weight-500">Bạn có muốn
										xóa sản phẩm này khỏi giỏ hàng không?</h4>
									<div class="padding-bottom-30 row"
										...
										<div class="col-6">
											<a class="btn btn-primary"
												href="/assignment_java_5/shop/cart/remove/${orderDetail.product.id }"><i
